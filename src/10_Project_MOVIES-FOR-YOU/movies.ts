...
const moviesFormatted: MovieItems[] = movies.map(movie => ({
    movieName: movie[0],
    year: movie[1],
    director: movie[2],
    movieLength: movie[3],
...
const sortYearDown = document.querySelector(".year-down");
const sortBestRate = document.querySelector(".best-rate");
...
function renderMovies(singleMovies: MovieItems[]){
    ...
    singleMovies.forEach((singleMovieItem) => {
        ...
        movieCard.classList.add("movie-items");

        // * alle Kategorien erstellen
        const movieTitle = document.createElement("h2");
        movieTitle.innerText = singleMovieItem.movieName;

        const year = document.createElement("p");
        year.innerText = singleMovieItem.year;
...
// * Aufruf der FN
renderMovies(moviesFormatted)


// * Search-Funktion
searchButton?.addEventListener("click", () => filterMovieName(userSearchInput ? userSearchInput.value : ""));
...
// * Eventlistener auf die Buttons + Such-FN
sortYearUp?.addEventListener("click", sortedYearUp);
sortYearDown?.addEventListener("click", sortedYearDown);
sortBestRate?.addEventListener("click", sortedRateDown);
...
function sortedYearUp() {
    ...
    sortedYear.sort((a, b) => Number(a.year) - Number(b.year));
...
function sortedRateDown() {
    ...
    console.log("ich wurde geklickt");
    const sortedRate = [...moviesFormatted];
    sortedRate.sort((a, b) => Number(b.rating) - Number(a.rating));
